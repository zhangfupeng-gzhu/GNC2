      FUNCTION rtsafe(funcd,xinit,x1,x2,xacc,par)
      INTEGER MAXIT
      REAL(8) rtsafe,x1,x2,xacc,xinit,par(50)
      EXTERNAL funcd
      PARAMETER (MAXIT=100)
      INTEGER j
      REAL(8) df,dx,dxold,f,fh,fl,temp,xh,xl
      call funcd(x1,fl,df,par)
      call funcd(x2,fh,df,par)
